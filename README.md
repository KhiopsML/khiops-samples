...
- Small text classification problem, with one singe text variable
- Dimensions: 6726 instances, 2 variables

### WineReviews
- Source: https://www.kaggle.com/datasets/zynicide/wine-reviews
- Description: Regression problem, where the problem where the objective is to predict the note of the wine review

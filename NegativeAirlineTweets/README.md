...
Text classification problem, where the objective is to predict the reason of a tweet with a negative sentiment (target variable `negativereason`)
...
- Preprocessing
  ...
  - Recode records using single-line text values instead of the original multi-line text values (hundreds of impacted records) 
